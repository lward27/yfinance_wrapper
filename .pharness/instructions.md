...
- Treat the environment snapshot and `.pharness/repository.yaml` as authoritative. Do not probe for Python, Docker, package managers, internet access, or operating-system details.
